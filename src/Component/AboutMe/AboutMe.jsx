...
const AboutMe = () => {
  return (
    <div data-aos="fade-up-right" className="w-full dark:bg-gray-900 overflow-auto">
      <div className="pt-10 pb-5 w-11/12 mx-auto text-gray-800 dark:text-gray-200">
        ...
        <div className="pt-10 text-lg space-y-2 text-justify">
          ...
          <p>
            ...
            favorite playground. I love building interactive web applications
            that feel smooth and dynamic. There's something deeply satisfying
            about crafting <b>full-stack projects</b> that solve real problems —
            from front-end design to backend logic, I enjoy owning the entire
            workflow.
          </p>{" "}
          <p>
            ...
            new places and cultures — traveling refreshes my creativity and
            helps me see the world through different lenses.
          </p>{" "}
          <p>
            As a person,{" "}
            <strong>
              I'm detail-oriented, always eager to learn independently, and
              driven by curiosity.
            </strong>{" "}
            ...
            who share a passion for clean code and clever solutions. Whether
            it's coding, reading, or exploring, I'm always looking for stories —
